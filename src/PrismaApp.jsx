...
import {
  ...
  FolderOpen, HardHat, ShieldAlert, Sparkles, User, Award, Home, LayoutGrid
} from "lucide-react";
...
const ESTADOS_MEXICO = [
  { id: "AGS", nombre: "Aguascalientes", factor: 0.95 },
  { id: "BC",  nombre: "Baja California", factor: 1.18 },
  { id: "BCS", nombre: "Baja California Sur", factor: 1.25 },
  { id: "CAM", nombre: "Campeche", factor: 1.05 },
  { id: "CHP", nombre: "Chiapas", factor: 0.90 },
  ...
  { id: "HID", nombre: "Hidalgo", factor: 0.92 },
  { id: "JAL", nombre: "Jalisco", factor: 1.05 },
  { id: "MEX", nombre: "Estado de México", factor: 0.98 },
  { id: "MIC", nombre: "Michoacán", factor: 0.95 },
  { id: "MOR", nombre: "Morelos", factor: 0.96 },
  { id: "NAY", nombre: "Nayarit", factor: 1.02 },
  { id: "NLE", nombre: "Nuevo León", factor: 1.15 },
  ...
  { id: "TAB", nombre: "Tabasco", factor: 1.04 },
  { id: "TAM", nombre: "Tamaulipas", factor: 1.06 },
  { id: "TLA", nombre: "Tlaxcala", factor: 0.90 },
  { id: "VER", nombre: "Veracruz", factor: 0.96 },
  { id: "YUC", nombre: "Yucatán", factor: 1.05 },
...
const TIPOLOGIAS_EDIFICACION = {
  ...
  vivienda_res:    { nombre: "Vivienda Residencial", baseMin: 18500, baseMax: 26000 },
  vivienda_lujo:   { nombre: "Vivienda Residencial de Lujo", baseMin: 28000, baseMax: 42000 },
  comercio_local:  { nombre: "Comercio / Locales en Planta Baja", baseMin: 11000, baseMax: 15500 },
  uso_mixto:       { nombre: "Edificio Mixto (Comercio + Vivienda/Oficinas)", baseMin: 16000, baseMax: 23000 },
  oficinas:        { nombre: "Corporativo / Oficinas (Obra Gris + Fitout)", baseMin: 15000, baseMax: 22000 },
  educativo:       { nombre: "Equipamiento Educativo / Escuelas", baseMin: 10500, baseMax: 14500 },
  industrial:      { nombre: "Nave Industrial / Bodega", baseMin: 6500, baseMax: 9500 },
};
...
const DEFAULT_MATERIALES = [
  ...
  { id: "azulejo_kit", codigo: "MAT-06", descripcion: "Azulejo + Adhesivo + Boquilla", unidad: "m2", precio: 380, marca: "El Surtidor" },
  ...
  { id: "concreto_pulido_insumo", codigo: "MAT-17", descripcion: "Insumos Concreto Pulido", unidad: "m2", precio: 240, marca: "Cemex" },
  ...
  { id: "aluminio_nacional", codigo: "MAT-23", descripcion: "Perfil Aluminio Línea Nacional", unidad: "m2", precio: 1950, marca: "El Surtidor" },
  { id: "herreria_estructural", codigo: "MAT-24", descripcion: "Herrería Estructural + Cristal", unidad: "m2", precio: 1800, marca: "Ferretería La Siete" },
  { id: "kit_salida_electrica", codigo: "MAT-25", descripcion: "Kit Salida Eléctrica hasta 3m", unidad: "pza", precio: 450, marca: "Eléctrica Santiago" },
  ...
  { id: "flete_pesado", codigo: "MAT-29", descripcion: "Acarreo/Retiro Escombro", unidad: "m2", precio: 35, marca: "Ferretería La Siete" },
  { id: "flete_ligero", codigo: "MAT-30", descripcion: "Acarreo Escombro ligero", unidad: "m2", precio: 22, marca: "Ferretería La Siete" },
  { id: "flete_piso", codigo: "MAT-31", descripcion: "Acarreo Escombro piso", unidad: "m2", precio: 28, marca: "Ferretería La Siete" },
  { id: "flete_carpinteria", codigo: "MAT-32", descripcion: "Acarreo Puertas y Ventanas", unidad: "m2", precio: 20, marca: "Ferretería La Siete" },
  { id: "fijaciones_reubicacion", codigo: "MAT-33", descripcion: "Consumibles de Reubicación", unidad: "pza", precio: 120, marca: "Ferretería La Siete" },
  { id: "tablaroca_st_insumo", codigo: "MAT-34", descripcion: "Panel Tablaroca ST 1/2\"", unidad: "m2", precio: 145, marca: "USG" },
  { id: "tablaroca_rh_insumo", codigo: "MAT-35", descripcion: "Panel Tablaroca RH 1/2\"", unidad: "m2", precio: 195, marca: "USG" },
  { id: "durock_insumo", codigo: "MAT-36", descripcion: "Panel Durock 1/2\"", unidad: "m2", precio: 380, marca: "USG" },
  { id: "adhesivo_mortero", codigo: "MAT-37", descripcion: "Adhesivo Mortero (Festerbond)", unidad: "ml", precio: 18, marca: "Fester" },
  { id: "mortero_resane", codigo: "MAT-38", descripcion: "Mortero / Yeso p/Resane", unidad: "ml", precio: 25, marca: "Cemex" },
];

const DEFAULT_MANO_OBRA = [
  { id: "MO-01", codigo: "MO-01", descripcion: "Cuadrilla Albañilería (Oficial + Peón)", integrantes: 2, unidad: "jornada", precio: 1350 },
  { id: "MO-02", codigo: "MO-02", descripcion: "Cuadrilla Tablaroquero (Oficial + Ayudante)", integrantes: 2, unidad: "jornada", precio: 1200 },
  { id: "MO-03", codigo: "MO-03", descripcion: "Cuadrilla Pintor (Oficial + Peón)", integrantes: 2, unidad: "jornada", precio: 1100 },
  { id: "MO-04", codigo: "MO-04", descripcion: "Cuadrilla Electricista / Plomero", integrantes: 2, unidad: "jornada", precio: 1300 },
  { id: "MO-05", codigo: "MO-05", descripcion: "Cuadrilla Fierrero / Estructurista", integrantes: 2, unidad: "jornada", precio: 1450 },
  { id: "MO-06", codigo: "MO-06", descripcion: "Cuadrilla Aluminero / Cancelero", integrantes: 2, unidad: "jornada", precio: 1350 },
];
...
const DEFAULT_EQUIPO = [
  ...
  { id: "EQ-03", codigo: "EQ-03", descripcion: "Bailarina Aplanadora", unidad: "día", precio: 750 },
  { id: "EQ-04", codigo: "EQ-04", descripcion: "Herramienta Mayor", unidad: "día", precio: 350 },
];
...
const MATRICES = {
  ...
  demol_ligero: { nombre: "Demolición Muro Ligero", unidad: "m2", materiales: [{ id: "flete_ligero", cant: 1 }], cuadrilla: "MO-01", rendimiento: 20 },
  demol_piso: { nombre: "Demolición / Levantamiento de Piso", unidad: "m2", materiales: [{ id: "flete_piso", cant: 1 }], cuadrilla: "MO-01", rendimiento: 15 },
  demol_vano: { nombre: "Retiro de Puertas y Ventanas", unidad: "m2", materiales: [{ id: "flete_carpinteria", cant: 1 }], cuadrilla: "MO-06", rendimiento: 25 },
  ...
  muro_tablaroca_st_1c: { nombre: "Muro Ligero Tablaroca ST (1 cara)", unidad: "m2", materiales: [{ id: "tablaroca_st_insumo", cant: 1 }], cuadrilla: "MO-02", rendimiento: 20 },
  muro_tablaroca_st_2c: { nombre: "Muro Ligero Tablaroca ST (2 caras)", unidad: "m2", materiales: [{ id: "tablaroca_st_insumo", cant: 1.85 }], cuadrilla: "MO-02", rendimiento: 14 },
  muro_tablaroca_rh_1c: { nombre: "Muro Ligero Tablaroca RH (1 cara)", unidad: "m2", materiales: [{ id: "tablaroca_rh_insumo", cant: 1 }], cuadrilla: "MO-02", rendimiento: 18 },
  muro_tablaroca_rh_2c: { nombre: "Muro Ligero Tablaroca RH (2 caras)", unidad: "m2", materiales: [{ id: "tablaroca_rh_insumo", cant: 1.85 }], cuadrilla: "MO-02", rendimiento: 12 },
  muro_durock_1c: { nombre: "Muro Ligero Durock (1 cara)", unidad: "m2", materiales: [{ id: "durock_insumo", cant: 1 }], cuadrilla: "MO-02", rendimiento: 12 },
  muro_durock_2c: { nombre: "Muro Ligero Durock (2 caras)", unidad: "m2", materiales: [{ id: "durock_insumo", cant: 1.85 }], cuadrilla: "MO-02", rendimiento: 8 },
  resane_emboquillado: { nombre: "Emboquillado en Vano", unidad: "ml", materiales: [{ id: "mortero_resane", cant: 1 }], cuadrilla: "MO-01", rendimiento: 15 },
  resane_huella: { nombre: "Resane / Cierre de Huella", unidad: "ml", materiales: [{ id: "mortero_resane", cant: 1 }, { id: "adhesivo_mortero", cant: 1 }], cuadrilla: "MO-01", rendimiento: 12 },
  resane_rozas: { nombre: "Resane Rozas / Ranuras", unidad: "ml", materiales: [{ id: "mortero_resane", cant: 1 }], cuadrilla: "MO-01", rendimiento: 18 },
  acabado_Enjarre: { nombre: "Enjarre Cemento-Arena", unidad: "m2", materiales: [{ id: "cemento_arena_aplanado", cant: 1 }], cuadrilla: "MO-01", rendimiento: 12 },
  ...
  acabado_Azulejo: { nombre: "Recubrimiento Azulejo", unidad: "m2", materiales: [{ id: "azulejo_kit", cant: 1 }], cuadrilla: "MO-01", rendimiento: 7 },
  ...
  firme: { nombre: "Firme Concreto Interior f'c=200", unidad: "m2", materiales: [{ id: "concreto_200", cant: 1 }, { id: "malla_electrosoldada", cant: 1 }], cuadrilla: "MO-01", rendimiento: 25 },
...
function findPrecio(priceBook, id, factorZona = 1) {
  const m = priceBook.materiales.find((x) => x.id === id);
  return m ? m.precio * factorZona : 0;
}

function findCuadrilla(priceBook, codigo, factorZona = 1) {
  const c = priceBook.manoObra.find((x) => x.codigo === codigo) || { precio: 0, descripcion: "—", codigo };
  return { ...c, precio: c.precio * factorZona };
}

function calcConcepto(matrizKey, cantidad, priceBook, params, overrideRendimiento, factorZona = 1) {
  ...
  const matDetalle = mz.materiales.map((m) => {
    ...
    const precioBase = insumo ? insumo.precio : 0;
    const precioAjustado = precioBase * factorZona;
    return { id: m.id, codigo: insumo?.codigo, descripcion: insumo?.descripcion || m.id, unidad: insumo?.unidad || "", cantidad: m.cant, precio: precioAjustado, importe: precioAjustado * m.cant };
  });
  const costoMaterialesM2 = matDetalle.reduce((a, b) => a + b.importe, 0);
  const cuadrilla = findCuadrilla(priceBook, mz.cuadrilla, factorZona);
...
function calcPreliminares(p, priceBook, params, factorZona) {
  const items = [];
  const cantTrazo = num(p.trazo.m2);
  if (cantTrazo > 0) {
    if (p.trazo.puRapido) {
      const pu = num(p.trazo.puRapido) * factorZona;
      items.push({ id: "trazo", concepto: "Trazo y Nivelación", unidad: "m2", cantidad: cantTrazo, puTotal: pu, total: pu * cantTrazo, manual: true });
    } else {
      items.push({ id: "trazo", concepto: "Trazo y Nivelación", ...calcConcepto("trazo", cantTrazo, priceBook, params, null, factorZona) });
    }
  }
  p.demoliciones.forEach((d) => {
    ...
    items.push({ id: d.id, concepto: `Demolición / Retiro de ${desc}`, ...calcConcepto(key, cant, priceBook, params, null, factorZona) });
  });
  p.conceptosExtra.forEach((c) => {
    const cant = num(c.cantidad), pu = num(c.pu) * factorZona;
    if (cant <= 0) return;
...
function calcAlbanileria(p, priceBook, params, factorZona) {
  const items = [];
  const cantMuro = num(p.muros.m2);
  if (cantMuro > 0) {
    items.push({ id: "muro", concepto: "Muro de Tabique Rojo Recocido", ...calcConcepto("muro_tabique", cantMuro, priceBook, params, null, factorZona) });
    const caraB = p.muros.mismoAcabado ? p.muros.caraA : p.muros.caraB;
    items.push({ id: "caraA", concepto: `Acabado Cara A: ${p.muros.caraA}`, ...calcConcepto(`acabado_${p.muros.caraA}`, cantMuro, priceBook, params, null, factorZona) });
    items.push({ id: "caraB", concepto: `Acabado Cara B: ${caraB}`, ...calcConcepto(`acabado_${caraB}`, cantMuro, priceBook, params, null, factorZona) });
  }
  ...
  if (p.murosLigeros && p.murosLigeros.length > 0) {
    p.murosLigeros.forEach((ml) => {
      ...
      items.push({
        id: ml.id,
        concepto: `Muro Ligero: ${ml.tipo === "st" ? "Tablaroca ST" : ml.tipo === "rh" ? "Tablaroca RH" : "Durock"} a ${ml.caras} cara(s)`,
        ...calcConcepto(key, cant, priceBook, params, null, factorZona)
      });
    });
  }
  ...
  if (p.resanes && p.resanes.length > 0) {
    p.resanes.forEach((r) => {
      ...
      items.push({
        id: r.id,
        concepto: `Resane: ${r.tipo === "emboquillado" ? "Emboquillado en vano" : r.tipo === "huella" ? "Cierre de huella" : "Cierre de rozas"}`,
        ...calcConcepto(key, cantMl, priceBook, params, null, factorZona)
      });
    });
  }

  const cantFirme = num(p.firmes.m2);
  if (cantFirme > 0) items.push({ id: "firme", concepto: "Firme de Concreto Interior f'c=200", ...calcConcepto("firme", cantFirme, priceBook, params, null, factorZona) });
  
  return items;
}

function calcEstructuras(p, priceBook, params, factorZona) {
  return p.elementos.map((el) => {
    const pConcreto = findPrecio(priceBook, "concreto_250", factorZona);
    const pAcero = findPrecio(priceBook, "acero_varilla", factorZona);
    const pCimbra = findPrecio(priceBook, "cimbra_madera", factorZona);
    const cuadrilla = findCuadrilla(priceBook, "MO-05", factorZona);
    ...
    if (el.tipo === "Zapata Aislada (1.20x1.20m)") {
      ...
      return {
        id: el.id, concepto: `Zapata Aislada Paramétrica 1.20x1.20 m`, unidad: "pieza", cantidad: piezas,
        matDetalle: [
          ...
          { codigo: "MAT-11", descripcion: "Acero de Refuerzo fy=4200", unidad: "kg", cantidad: Number(kgAcero.toFixed(1)), precio: pAcero, importe: cAcero },
    ...
    if (el.tipo === "Zapata Corrida c/Contratrabe") {
      ...
      return {
        id: el.id, concepto: `Zapata Corrida c/Contratrabe`, unidad: "ml", cantidad: ml,
        matDetalle: [
          { codigo: "MAT-10", descripcion: "Concreto Premezclado f'c=250", unidad: "m3", cantidad: Number(volConc.toFixed(2)), precio: pConcreto, importe: cConc },
          { codigo: "MAT-11", descripcion: "Acero de Refuerzo fy=4200", unidad: "kg", cantidad: Number(kgAcero.toFixed(1)), precio: pAcero, importe: cAcero },
          { codigo: "MAT-12", descripcion: "Cimbra de Madera", unidad: "m2", cantidad: Number(m2Cimbra.toFixed(2)), precio: pCimbra, importe: cCimb },
    ...
    return {
      ...
      matDetalle: [
        ...
        { codigo: "MAT-11", descripcion: `Acero de Refuerzo`, unidad: "kg", cantidad: Number(aceroKg.toFixed(1)), precio: pAcero, importe: costoAcero },
...
function calcAcabados(p, priceBook, params, factorZona) {
  const items = [];
  ...
  if (cant > 0) {
    ...
    items.push({ id: "pintura", concepto: `${p.pintura.tipo === "vinilica" ? "Pintura Vinílica (2 manos)" : "Pasta Texturizada"}`, ...calcConcepto(key, cant, priceBook, params, null, factorZona) });
  }
  return items;
}

function calcPisos(p, priceBook, params, factorZona) {
  const cant = num(p.m2);
  if (cant <= 0) return [];
  const key = MAPA_PISOS_MATRIZ[p.tipo] || "piso_ceramico_mat";
  return [{ id: "piso", concepto: `Piso ${p.tipo}`, ...calcConcepto(key, cant, priceBook, params, null, factorZona) }];
}

function calcCanceleria(p, priceBook, params, factorZona) {
  return p.elementos.map((el) => {
    ...
    const cuadrilla = findCuadrilla(priceBook, "MO-06", factorZona);

    if (el.accion === "reubicacion") {
      const pInsumo = findPrecio(priceBook, "fijaciones_reubicacion", factorZona);
      ...
      const total = costoMateriales + costoMO + herrMenor + eqSeguridad;
      return {
        id: el.id, concepto: `Reubicación de Cancelería (${el.ancho || 0}×${el.alto || 0}cm)`, unidad: "pieza", cantidad: 1,
        matDetalle: [{ codigo: "MAT-33", descripcion: "Consumibles de Reubicación", unidad: "pza", cantidad: 1, precio: pInsumo, importe: costoMateriales }],
        costoMateriales, cuadrilla, rendimiento, costoMO, herrMenor, eqSeguridad, puTotal: total, total,
      };
    }

    const matId = MATERIALES_CANCELERIA[el.material] || "aluminio_nacional";
    const precioM2 = findPrecio(priceBook, matId, factorZona);
    ...
    const total = costoMateriales + costoMO + herrMenor + eqSeguridad;
    return {
      id: el.id, concepto: `${el.elemento} ${el.material} — ${el.apertura}`, unidad: "pieza", cantidad: 1,
      matDetalle: [{ codigo: matId, descripcion: el.material, unidad: "m2", cantidad: Number(area.toFixed(2)), precio: precioM2, importe: costoMateriales }],
      costoMateriales, cuadrilla, rendimiento, costoMO, herrMenor, eqSeguridad, puTotal: total, total,
    };
  });
}

function calcInstalaciones(p, priceBook, params, factorZona) {
  const items = [];
  const gruposE = {};
  ...
  Object.entries(gruposE).forEach(([tipo, g]) => {
    ...
    const pKit = findPrecio(priceBook, "kit_salida_electrica", factorZona);
    const pMl = findPrecio(priceBook, "ml_cable_adicional", factorZona);
    const costoMateriales = g.cantidad * pKit + g.metros * pMl;
    const cuadrilla = findCuadrilla(priceBook, "MO-04", factorZona);
    const rendimiento = 4;
    ...
    const total = costoMateriales + costoMO + herrMenor + eqSeguridad;
    items.push({
      id: `elec-${tipo}`, concepto: `Salida Eléctrica: ${tipo}`, unidad: "salida", cantidad: g.cantidad,
      matDetalle: [{ codigo: "MAT-25", descripcion: "Kit Salida Eléctrica", unidad: "pza", cantidad: g.cantidad, precio: pKit, importe: g.cantidad * pKit }],
  ...
  Object.entries(gruposH).forEach(([tipo, cantidad]) => {
    ...
    const pKit = findPrecio(priceBook, "kit_salida_hidraulica", factorZona);
...
function calcExtraordinarios(p, priceBook, params, factorZona) {
  if (!p.conceptos || p.conceptos.length === 0) return [];
  return p.conceptos.map((c) => {
    const cant = num(c.cantidad);
    const pu = num(c.pu) * factorZona;
    const total = cant * pu;
    return {
      id: c.id, concepto: c.descripcion || "Trabajo Especial", unidad: c.unidad || "Lote", cantidad: cant, puTotal: pu, total: total, manual: true,
      matDetalle: [{ codigo: "EXTRA", descripcion: "Costo Directo Especial", unidad: c.unidad || "Lote", cantidad: cant, precio: pu, importe: total }]
    };
  });
}

function calcularPresupuesto(partidas, priceBook, params, factorZona = 1) {
  const calcMap = {
  ...
  const capitulos = CAPITULOS_META.map((meta) => {
    ...
    const itemsRaw = p.aplica ? calcMap[meta.key](p, priceBook, params, factorZona) : [];
    
    const items = itemsRaw.map(it => {
      const puTotalConSobrecosto = it.puTotal * factorSobrecosto;
      const totalConSobrecosto = it.total * factorSobrecosto;
      return { ...it, puTotalCliente: puTotalConSobrecosto, totalCliente: totalConSobrecosto };
    });
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6 my-4">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center justify-center p-3 bg-[color:var(--pr-ink)] rounded-2xl shadow-lg mb-2">
          <PrismaMark size={48} />
        </div>
      ...
      <SectionCard icon={User} title="1. Datos de Identificación Profesional" subtitle="Guardado automático en la memoria de este dispositivo">
        <div className="space-y-4">
          ...
          <Field label="Cédula Profesional">
            <div className="relative">
              <Award size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[color:var(--pr-muted)]" />
              <TextInput value={arqPerfil.cedula} onChange={(e) => setArqPerfil((p) => ({ ...p, cedula: e.target.value }))} placeholder="Ej. 12345678" className="pl-9" />
            </div>
          </Field>
        </div>
      </SectionCard>

      <SectionCard icon={MapPin} title="2. Selección Geográfica / Estado de la Obra" subtitle="Aplica automáticamente el factor regional a todos los costos">
        <Field label="Estado / Región de la República Mexicana">
          <Select value={estadoSel} onChange={(e) => setEstadoSel(e.target.value)}>
            {ESTADOS_MEXICO.map((est) => (
              <option key={est.id} value={est.id}>
                {est.nombre} (Factor: {est.factor.toFixed(2)}x)
              </option>
            ))}
          </Select>
        </Field>
        <div className="mt-3 p-3 bg-emerald-50 rounded-lg border border-emerald-200 text-[12px] text-emerald-900 flex items-center justify-between">
          <span><b>Región activa:</b> {estadoObj.nombre}</span>
          <span className="font-mono font-bold bg-emerald-200/60 text-emerald-900 px-2 py-0.5 rounded">
            Factor: {estadoObj.factor.toFixed(2)}x
          </span>
        </div>
      </SectionCard>

      <div className="pt-2">
        <Btn onClick={onIniciarModule} className="w-full py-3.5 text-[14px]">
          Iniciar Selección de Módulo <ArrowRight size={16} />
        </Btn>
      </div>
    </div>
  );
...
function ScreenModuleSelector({ estadoSel, onSelectModule, arqPerfil }) {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 my-6">
      <div className="flex items-center justify-between border-b border-[color:var(--pr-line)] pb-4">
        <div>
        ...
        <div className="text-right">
          <span className="text-[11px] uppercase font-bold text-[color:var(--pr-muted)] block">Zona de Trabajo</span>
          <span className="text-[13px] font-bold text-[color:var(--pr-green-ink)]">{estadoObj.nombre}</span>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="rounded-xl bg-white border border-[color:var(--pr-line)] p-6 space-y-4 hover:border-[color:var(--pr-green)] transition-all shadow-sm flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <h3 className="font-display text-[17px] text-[color:var(--pr-ink)]">1. Paramétrico de Costos (APU)</h3>
            <p className="text-[13px] text-[color:var(--pr-muted)] leading-relaxed">
              Catálogo completo de conceptos por partidas (albañilería, estructuras, acabados, cancelería e instalaciones). Ideal para presupuestos ejecutivos.
            </p>
          </div>
          <Btn onClick={() => onSelectModule("apu")} variant="dark" className="w-full mt-4">
            Abrir Cotizador por Partidas <ArrowRight size={15} />
          </Btn>
        </div>
        ...
        <div className="rounded-xl bg-white border-2 border-[color:var(--pr-green)] p-6 space-y-4 hover:shadow-md transition-all flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <h3 className="font-display text-[17px] text-[color:var(--pr-ink)]">2. Paramétrico por m² de Edificación</h3>
            <p className="text-[13px] text-[color:var(--pr-muted)] leading-relaxed">
              Estimador exprés para primera cita con cliente. Calcula inversión total aproximada filtrando por género de edificación, niveles y gama de acabados.
            </p>
          </div>
          <Btn onClick={() => onSelectModule("m2")} variant="solid" className="w-full mt-4">
            Abrir Paramétrico por m² <ArrowRight size={15} />
          </Btn>
        </div>
      </div>
    </div>
...
/* -------------------------------------------------------------------------
   PANTALLA MÓDULO NUEVO: PARAMÉTRICO POR M² DE EDIFICACIÓN
   ------------------------------------------------------------------------- */
function ScreenParametricoM2({ estadoSel, arqPerfil, onVolver }) {
  const estadoObj = ESTADOS_MEXICO.find((e) => e.id === estadoSel) || ESTADOS_MEXICO[8];
  
  const [nombreCliente, setNombreCliente] = useState("");
  const [tipologia, setTipologia] = useState("vivienda_res");
  const [niveles, setNiveles] = useState(2);
  const [m2Planta, setM2Planta] = useState(120);
  ...
  const indirectosMin = useMemo(() => subtotalObraMin * (pctIndirectos / 100), [subtotalObraMin, pctIndirectos]);
  const indirectosMax = useMemo(() => subtotalObraMax * (pctIndirectos / 100), [subtotalObraMax, pctIndirectos]);

  const proyectoEjecMin = useMemo(() => subtotalObraMin * (pctProyecto / 100), [subtotalObraMin, pctProyecto]);
  const proyectoEjecMax = useMemo(() => subtotalObraMax * (pctProyecto / 100), [subtotalObraMax, pctProyecto]);

  const totalInversionMin = useMemo(() => subtotalObraMin + indirectosMin + proyectoEjecMin, [subtotalObraMin, indirectosMin, proyectoEjecMin]);
  const totalInversionMax = useMemo(() => subtotalObraMax + indirectosMax + proyectoEjecMax, [subtotalObraMax, indirectosMax, proyectoEjecMax]);

  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between no-print">
        <Btn variant="ghost" onClick={onVolver}><ArrowLeft size={16} /> Volver a Menú</Btn>
        <Btn variant="outline" onClick={() => window.print()}><Download size={16} /> Exportar / Imprimir Ficha</Btn>
      </div>

      <SectionCard icon={Calculator} title="Paramétrico por m² de Edificación" subtitle={`Ajustado para: ${estadoObj.nombre} (Factor ${estadoObj.factor.toFixed(2)}x)`}>
        <div className="grid sm:grid-cols-2 gap-4">
          <Field label="Cliente / Proyecto"><TextInput value={nombreCliente} onChange={(e) => setNombreCliente(e.target.value)} placeholder="Ej. Residencia Cancún / Cliente López" /></Field>
          <Field label="Género / Tipología de Edificación">
            <Select value={tipologia} onChange={(e) => setTipologia(e.target.value)}>
              {Object.entries(TIPOLOGIAS_EDIFICACION).map(([k, v]) => (
                <option key={k} value={k}>{v.nombre}</option>
              ))}
            </Select>
          </Field>
          <Field label="Superficie por Planta (m²)"><NumberInput value={m2Planta} onChange={(e) => setM2Planta(e.target.value)} min="1" /></Field>
      ...
      <div className="rounded-xl overflow-hidden border border-[color:var(--pr-line)] bg-white shadow-sm space-y-4 p-6">
        <div className="border-b pb-3 flex justify-between items-center flex-wrap gap-2">
          <div>
            <span className="text-[11px] font-bold uppercase tracking-wider text-[color:var(--pr-muted)]">Resumen de Superficie Proyectada</span>
            <div className="font-display text-[20px] text-[color:var(--pr-ink)]">{totalM2Construccion.toLocaleString()} m² Totales de Construcción</div>
          </div>
          <div className="text-right">
            <span className="text-[11px] font-bold uppercase tracking-wider text-[color:var(--pr-muted)]">Rango Promedio Regional ($/m²)</span>
            <div className="font-mono text-[15px] font-bold text-emerald-800">{money(costoMinM2)} - {money(costoMaxM2)} / m²</div>
          </div>
        </div>

        <div className="grid sm:grid-cols-2 gap-6 pt-2">
          <div className="space-y-2 p-4 bg-slate-50 rounded-xl border border-slate-200">
            <div className="font-display text-[14px] text-slate-700 uppercase">Límite Inferior (Gama Media/Básica)</div>
            <div className="text-[12.5px] space-y-1 text-slate-600">
              <div className="flex justify-between"><span>Costo Directo de Obra:</span> <b>{money(subtotalObraMin)}</b></div>
              <div className="flex justify-between"><span>Indirectos ({pctIndirectos}%):</span> <b>{money(indirectosMin)}</b></div>
              <div className="flex justify-between"><span>Proyecto Ejecutivo ({pctProyecto}%):</span> <b>{money(proyectoEjecMin)}</b></div>
              <div className="border-t pt-2 flex justify-between font-display text-[16px] text-slate-900">
                <span>Inversión Est. Min:</span>
                <span>{money(totalInversionMin)}</span>
              </div>
            </div>
          </div>

          <div className="space-y-2 p-4 bg-emerald-50 rounded-xl border border-emerald-200">
            <div className="font-display text-[14px] text-emerald-900 uppercase">Límite Superior (Gama Alta/Lujo)</div>
            <div className="text-[12.5px] space-y-1 text-emerald-800">
              <div className="flex justify-between"><span>Costo Directo de Obra:</span> <b>{money(subtotalObraMax)}</b></div>
              <div className="flex justify-between"><span>Indirectos ({pctIndirectos}%):</span> <b>{money(indirectosMax)}</b></div>
              <div className="flex justify-between"><span>Proyecto Ejecutivo ({pctProyecto}%):</span> <b>{money(proyectoEjecMax)}</b></div>
              <div className="border-t border-emerald-300 pt-2 flex justify-between font-display text-[16px] text-emerald-950">
                <span>Inversión Est. Max:</span>
                <span>{money(totalInversionMax)}</span>
              </div>
            </div>
          </div>
        </div>
...
function Header({ screen, setScreen, cliente, estadoSel, onVolverMenu }) {
  const estadoObj = ESTADOS_MEXICO.find((e) => e.id === estadoSel) || ESTADOS_MEXICO[8];
  return (
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5 min-w-0">
            <button onClick={onVolverMenu} className="hover:opacity-80 transition-opacity flex items-center gap-2">
              <PrismaMark />
              <div className="min-w-0 leading-none text-left">
                ...
                <div className="text-[10.5px] text-white/50 tracking-wide uppercase mt-0.5 truncate">Paramétrico APU — {cliente ? cliente : "Nuevo presupuesto"}</div>
              </div>
            </button>
          </div>
          <button onClick={onVolverMenu} className="text-[11px] bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-md font-bold uppercase tracking-wider flex items-center gap-1.5">
            <LayoutGrid size={14} /> Cambiar Módulo ({estadoObj.id})
          </button>
        </div>
      </div>
...
export default function PrismaApp() {
  ...
  const estadoObj = useMemo(() => ESTADOS_MEXICO.find((e) => e.id === estadoSel) || ESTADOS_MEXICO[8], [estadoSel]);
  const factorZona = estadoObj.factor;

  const presupuesto = useMemo(() => calcularPresupuesto(partidas, priceBook, params, factorZona), [partidas, priceBook, params, factorZona]);
  ...
  const handleGuardarHistorial = () => {
    const entry = { id: uid(), fecha: new Date().toLocaleDateString("es-MX"), cliente: proyecto.cliente, total: presupuesto.total, proyecto, partidas, params, estadoSel };
  ...
  const handleCargarHistorial = (h) => {
    setProyecto(h.proyecto); setPartidas(h.partidas); setParams(h.params); 
    if (h.estadoSel) setEstadoSel(h.estadoSel);
    setScreen(5);
  ...
  return (
    <div style={{ "--pr-canvas": "#EEF0EC", "--pr-ink": "#14181B", "--pr-green": "#22C55E", "--pr-green-ink": "#15803D", "--pr-line": "#DDDFD8", "--pr-muted": "#697068" }} className="min-h-screen">
      ...
      {moduloActivo === "selector" && (
        <main className="no-print max-w-6xl mx-auto px-4 py-6">
          <ScreenModuleSelector estadoSel={estadoSel} arqPerfil={arqPerfil} onSelectModule={(m) => setModuloActivo(m)} />
        </main>
      )}
      ...
      {moduloActivo === "apu" && (
        <>
          <Header screen={screen} setScreen={setScreen} cliente={proyecto.cliente} estadoSel={estadoSel} onVolverMenu={() => setModuloActivo("selector")} />
          <main className="no-print max-w-6xl mx-auto px-4 py-6 pb-16">
            {screen === 1 && <Screen1 proyecto={proyecto} setProyecto={setProyecto} params={params} setParams={setParams} onNext={() => setScreen(2)} estadoSel={estadoSel} />}
            {screen === 2 && <Screen2 partidas={partidas} setPartidas={setPartidas} priceBook={priceBook} params={params} factorZona={factorZona} />}
            {screen === 3 && <Screen3 partidas={partidas} priceBook={priceBook} params={params} factorZona={factorZona} />}
            {screen === 4 && <Screen4 priceBook={priceBook} setPriceBook={setPriceBook} onSaveAsDefault={handleSaveAsDefault} />}
            {screen === 5 && <Screen5 proyecto={proyecto} presupuesto={presupuesto} params={params} onSave={handleGuardarHistorial} historial={historial} onLoadHistorial={handleCargarHistorial} onDeleteHistorial={handleEliminarHistorial} arqPerfil={arqPerfil} estadoObj={estadoObj} />}
          ...
          <PrintReport proyecto={proyecto} presupuesto={presupuesto} arqPerfil={arqPerfil} estadoObj={estadoObj} />
        </>
      )}
...
/* -------------------------------------------------------------------------
   SUBPANTALLAS COMPLEMENTARIAS DEL COTIZADOR DE APU
   ------------------------------------------------------------------------- */
function Screen1({ proyecto, setProyecto, params, setParams, onNext, estadoSel }) {
  const set = (k, v) => setProyecto((p) => ({ ...p, [k]: v }));
  const estadoObj = ESTADOS_MEXICO.find((e) => e.id === estadoSel) || ESTADOS_MEXICO[8];

  return (
    <div className="space-y-5">
      <SectionCard icon={Building2} title="Registro de Proyecto y Cliente" subtitle={`Ajustando precios con Factor Regional de: ${estadoObj.nombre}`}>
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <Field label="Superficie a Intervenir (m²)">
            <div className="relative">
              ...
              <NumberInput value={proyecto.superficie} onChange={(e) => set("superficie", e.target.value)} placeholder="0" min="0" className="pl-9" />
            </div>
          </Field>
        </div>
      </SectionCard>

      <SectionCard icon={Settings2} title="Parámetros Generales y Reglas de Cobro" subtitle="Configuración de sobrecostos e imprevistos">
...
function Screen3({ partidas, priceBook, params, factorZona }) {
  const presupuesto = useMemo(() => calcularPresupuesto(partidas, priceBook, params, factorZona), [partidas, priceBook, params, factorZona]);
...
function Screen5({ proyecto, presupuesto, params, onSave, historial, onLoadHistorial, onDeleteHistorial, arqPerfil, estadoObj }) {
        ...
        <div className="flex items-center justify-between border-b-2 border-[#14181B] pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-[#5B6560]">Presupuesto Paramétrico de Obra — Región {estadoObj.nombre}</div>
            </div>
          </div>
